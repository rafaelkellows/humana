    ...
    <main class="conheca">
        ...
        <section class="box-parallixit">
            ...
            <figure class="bxn-parallixit top">
                ...
                <figcaption>Conheça a Humana Magna – Uma instituição focada na atenção aos pacientes que necessitam de cuidados continuados. </figcaption>
            </figure>

            <h4>Conheça a Humana Magna -<br>Uma instituição focada na atenção aos pacientes que necessitam de cuidados continuados. </h4>
        ...
        <article>
            ...
            <aside>
                ...
                <p><strong>Com 78 leitos equipados, sendo que 52 são</strong></p>
            </aside>
            ...
            <aside>
                <p><strong>suítes e 13 quartos duplos,</strong> hotelaria de altopadrão, refeitório, sala de eventos e recreação, solarium (400m²) e amplo estacionamento, a Humana Magna oferece uma estrutura completa de cuidados hospitalares com equipamentos de suporte à vida, rede de gases medicinais, centro de reabilitação totalmente equipado, farmácia, exames laboratoriais e de imagem, para que o processo seja realizado com muita consciência e atenção.</p>
