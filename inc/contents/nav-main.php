        <nav>
            <dl <?php  if ($subpage == "quemprecisa" or $subpage == "desospitalizacao" or $subpage == "comoajudar")  { echo " class='on'"; } ?>>
                <dt><h3><a href="quemprecisa.php" title="Saiba o que é desospitalização">Saiba o que é <strong>desospitalização</strong></a></h3></dt>
                <dd><a href="quemprecisa.php" title="O que fazer quando o paciente deve sair do hospital mas ainda precisa de cuidados?">O que fazer quando o paciente deve sair do hospital mas ainda precisa de cuidados?</a></dd>
            </dl>
