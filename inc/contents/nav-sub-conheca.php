...
switch ($subpage) {
    case "conheca":
        ...
        echo '<a href="equipe.php" title="A Equipe Humana"><span>A Equipe Humana</span></a>';
    ...
    case "equipe":
        ...
        echo '<a class="on" href="equipe.php" title="A Equipe Humana"><span>A Equipe Humana</span></a>';
        echo '<a href="filosofia.php" title="Nossa Filosofia"><span>Nossa Filosofia</span></a>';
        break;
    case "filosofia":
        echo '<a href="conheca.php" title="Quem Somos"><span>Quem Somos</span></a>';
