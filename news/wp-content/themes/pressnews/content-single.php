				...
				<div <?php post_class( 'rsrc-post-content' ); ?>>                            
					...
					<?php if ( get_theme_mod( 'post-nav-check', 1 ) == 1 ) : ?>                            
						<div class="post-navigation row">
							<div class="post-previous col-md-6"><?php previous_post_link( '%link', '<span class="meta-nav">' . __( 'Anterior:', 'pressnews' ) . '</span> %title' ); ?></div>
							<div class="post-next col-md-6"><?php next_post_link( '%link', '<span class="meta-nav">' . __( 'Próximo:', 'pressnews' ) . '</span> %title' ); ?></div>
						</div>
					<?php endif; ?>                            
